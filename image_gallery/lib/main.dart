  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        Provider<PictureService>(create: (_) => PictureService()),
        ChangeNotifierProvider<GalleryPageViewModel>(
            create: (_) => GalleryPageViewModel()),
      ],
      child: MyApp(),
    ),
  );
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamProvider<List<Picture>>(
        initialData: [],
        // using Provider to fetch a model and return a property from it? Fancy!
        create: (_) => Provider.of<PictureService>(context).allProductsForSale,
